...
test_on_all_seqs(predict_apex_titan_v47, "Apex Titan V47 Multi-Regime Master")
print("\n=== BENCHMARKING ON 2,000,000 ROUNDS ===")
test_candidate_both_ways(predict_apex_titan_v47, "Apex Titan V47 Multi-Regime Master")
