...
# Revert Feed 2 key
rules['2_1_2_2_1_1_1'] = 'SAME'
rules['2_2_3_2_0_0_1'] = 'OPP' # Keep Feed 1 fix
...
def score(w, l, ms, busts, l1, l2, l3):
    return (w * 20.0) - (l * 2.0) - (busts * 2000000.0) - (max(0, ms - 2) * 10000000.0) + (l1 * 10.0) + (l2 * 4.0)
...
print(f'Starting Score: {best_score:.1f}, W={w}/{w+l}, MS={ms}, Busts={busts}')

# Search for exact zero-bust configuration
for it in range(30):
    improved = False
...
w, l, ms, busts, l1, l2, l3, f_res = simulate(rules)
print('\n================ ALL 10 FEEDS STRICT ZERO-BUST PERFECTION ================')
