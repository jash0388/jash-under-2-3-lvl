...
(function () {
  ...
  // ── 3.2 100% STRICT /PRED WEB SIGNAL BRIDGE ────────────────
  ...
  function updateHud() {
    ...
    badge.textContent = running ? (pendingBet ? `⏳ BETTING ₹${pendingBet.stake} ON ${pendingBet.pred}` : `🎯 FOLLOWING /PRED (${GAME_MODE}) ACTIVE`) : `⏹ ENGINE (${GAME_MODE}) STOPPED`;
