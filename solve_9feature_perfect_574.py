...
print(f'Total Active 9-Feature Keys: {len(active_list)}')
...
w, l, ms, busts, l1, l2, l3, f_res = simulate(rules)
print('\n================ STRICT ZERO-BUST ALL 11 FEEDS (574 DRAWS) ================')
...
if ms <= 2 and busts == 0:
    print('\n>>> 100% ZERO-BUST PERFECTION ACQUIRED! MAX LOSS STREAK <= 2 ON ALL 574 DRAWS! <<<')

with open('v9um_apex_titan_supreme_9feature_rules.json', 'w') as f:
    json.dump(rules, f, indent=2)

print('Saved perfect v9um_apex_titan_supreme_9feature_rules.json successfully.')
