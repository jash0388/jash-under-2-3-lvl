...
with open('v9um_apex_titan_supreme_9feature_rules.json', 'r', encoding='utf-8') as f:
    rules_30s = json.load(f)

with open('v9um_apex_titan_supreme_9feature_1m_rules.json', 'r', encoding='utf-8') as f:
...
final_script = script_template.replace('RULES_30S_PLACEHOLDER', rules_30s_json)
final_script = final_script.replace('RULES_1M_PLACEHOLDER', rules_1m_json)
