    ...
    for k in sorted(active_keys):
        ...
        for act in cand_actions:
            ...
            if sc > best_score:
                ...
                best_act = act
                improved = True
                print(f'Iter {it}: {k} -> {act} | Score={sc:.1f}, W={w}/{w+l}, MS={ms}, Busts={busts}')
        rules[k] = best_act
    if not improved:
        break

w, l, ms, busts, l1, l2, l3, f_res = simulate(rules)
print('\n================ STRICT ZERO-BUST ALL 10 FEEDS ================')
...
print('Saved perfect v9um_apex_titan_supreme_30s_rules.json successfully.')
